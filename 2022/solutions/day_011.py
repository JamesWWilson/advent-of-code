...
class Monkey():
    def __init__(self, name): 
        ...
        self.inspection_counter: int = 0 #used to count number of items reviewed by monkey 

    def __repr__(self):
        return self.name

    def see(self):
        return [self.name,self.items,self.item_function,self.item_equation,self.test_divisor,self.pass_action]
